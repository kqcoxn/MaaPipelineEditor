...
## 更新摘要
**变更内容**
- 新增 Left、Right、Middle 等对齐选项，完善了对齐算法支持不同节点尺寸
...
**图表来源**
- [selectionContextMenu.tsx:350-399](file://src/components/flow/selectionContextMenu.tsx#L350-L399)
- [layout.ts:39-162](file://src/core/layout.ts#L39-L162)
...
**章节来源**
- [layout.ts:1-163](file://src/core/layout.ts#L1-L163)
...
U->>SCM : 选择对齐选项
SCM->>LH : 调用 align(direction, nodes)
...
**图表来源**
- [selectionContextMenu.tsx:222-232](file://src/components/flow/selectionContextMenu.tsx#L222-L232)
- [layout.ts:93-162](file://src/core/layout.ts#L93-L162)
- [graphSlice.ts:18-50](file://src/stores/flow/slices/graphSlice.ts#L18-L50)
...
**图表来源**
- [layout.ts:36-91](file://src/core/layout.ts#L36-L91)
- [graphSlice.ts:18-50](file://src/stores/flow/slices/graphSlice.ts#L18-L50)
...
**章节来源**
- [layout.ts:96-162](file://src/core/layout.ts#L96-L162)
...
## 结论
MaaPipelineEditor 的布局体系以 ELK 分层布局为核心，辅以对齐吸附与智能间距调整，既保证了复杂工作流的自动化排版，又保留了手动微调的能力。通过配置项与状态切片的协同，系统实现了稳定的布局体验与良好的可维护性。新增的 Left、Right、Middle 等对齐选项进一步增强了布局系统的灵活性，支持更精确的节点定位需求。

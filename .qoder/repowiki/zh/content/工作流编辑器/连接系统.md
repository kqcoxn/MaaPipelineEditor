...
- 标签与控制点
  ...
  - **新增**：控制点仅在贝塞尔模式下显示和可用，直角模式下禁用控制点拖拽
...
SmoothStep --> RenderEdge["渲染 BaseEdge"]
...
ControlPointCheck --> |直角模式| SkipControl["跳过控制点"]
...
- 完备的冲突检查与顺序管理
- 易于扩展的样式与配置体系
- **新增**：灵活的边走线模式选择，支持曲线和直角两种视觉风格
- **新增**：直角走线模式在复杂网络图中的性能优势

在复杂网络图场景下，建议结合路径模式与性能优化策略，以获得更佳的用户体验。直角走线模式特别适合需要规整布局的场景，而贝塞尔曲线模式则更适合追求流畅视觉效果的应用。
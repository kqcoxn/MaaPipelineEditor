...
- [dev\instructions\maafw-guide\1.1-快速开始.md](file://dev/instructions/maafw-guide/1.1-快速开始.md)
- [dev\instructions\maafw-guide\1.2-术语解释.md](file://dev/instructions/maafw-guide/1.2-术语解释.md)
- [dev\instructions\maafw-guide\2.1-集成文档.md](file://dev/instructions/maafw-guide/2.1-集成文档.md)
- [dev\instructions\maafw-guide\2.2-集成接口一览.md](file://dev/instructions/maafw-guide/2.2-集成接口一览.md)
- [dev\instructions\maafw-guide\2.3-回调协议.md](file://dev/instructions/maafw-guide/2.3-回调协议.md)
- [dev\instructions\maafw-guide\2.4-控制方式说明.md](file://dev/instructions/maafw-guide/2.4-控制方式说明.md)
- [dev\instructions\maafw-guide\3.1-任务流水线协议.md](file://dev/instructions/maafw-guide/3.1-任务流水线协议.md)
- [dev\instructions\maafw-guide\3.3-ProjectInterfaceV2协议.md](file://dev/instructions/maafw-guide/3.3-ProjectInterfaceV2协议.md)
- [dev\instructions\maafw-guide\4.1-构建指南.md](file://dev/instructions/maafw-guide/4.1-构建指南.md)
- [dev\instructions\maafw-guide\4.2-标准化接口设计.md](file://dev/instructions/maafw-guide/4.2-标准化接口设计.md)
- [dev\instructions\maafw-guide\5.1-问题反馈.md](file://dev/instructions/maafw-guide/5.1-问题反馈.md)
</cite>

## 更新摘要
**变更内容**
- 新增完整的中文MaaFramework开发者指南文档体系，包含11个核心文档
- 替代原有的英文版本文档，提供更完善的中文开发指导
- 增强了集成方案、回调协议、控制方式、项目接口等关键概念的详细说明
- 完善了Pipeline工作流、资源管理、调试与问题反馈的最佳实践
...
**更新** 新增完整的中文开发者指南文档体系，提供从快速开始到问题反馈的全流程指导
...
**图表来源**
- [dev\instructions\maafw-guide\2.2-集成接口一览.md:602-800](file://dev/instructions/maafw-guide/2.2-集成接口一览.md#L602-L800)
...
**图表来源**
- [dev\instructions\maafw-guide\2.2-集成接口一览.md:602-720](file://dev/instructions/maafw-guide/2.2-集成接口一览.md#L602-L720)
...
**更新** 新的中文开发者指南提供了更完善的技术选型指导和最佳实践建议
...
**章节来源**
- [dev\instructions\maafw-guide\1.2-术语解释.md:1-53](file://dev/instructions/maafw-guide/1.2-术语解释.md#L1-L53)
...
**章节来源**
- [dev\instructions\maafw-guide\1.1-快速开始.md:11-113](file://dev/instructions/maafw-guide/1.1-快速开始.md#L11-L113)
...
**图表来源**
- [dev\instructions\maafw-guide\3.1-任务流水线协议.md:54-78](file://dev/instructions/maafw-guide/3.1-任务流水线协议.md#L54-L78)

**章节来源**
- [dev\instructions\maafw-guide\3.1-任务流水线协议.md:54-78](file://dev/instructions/maafw-guide/3.1-任务流水线协议.md#L54-L78)
- [dev\instructions\maafw-guide\3.1-任务流水线协议.md:159-461](file://dev/instructions/maafw-guide/3.1-任务流水线协议.md#L159-L461)
...
### 回调协议详解
MaaFramework 通过统一的回调协议向上层应用发送状态通知和事件消息，支持资源加载、控制器动作、任务执行、节点处理等各类事件的实时反馈。

**章节来源**
- [dev\instructions\maafw-guide\2.3-回调协议.md:1-433](file://dev/instructions/maafw-guide/2.3-回调协议.md#L1-L433)

### 控制方式说明
详细说明了 ADB、Win32、MacOS、PlayCover、Gamepad、WlRoots 等多种控制方式的配置与使用，包括截图方式、输入方式、权限要求等关键信息。

**章节来源**
- [dev\instructions\maafw-guide\2.4-控制方式说明.md:1-285](file://dev/instructions/maafw-guide/2.4-控制方式说明.md#L1-L285)

### ProjectInterface 协议
标准化的项目接口协议，支持多语言、多控制器、多资源包的配置管理，提供任务分组、配置项、预设等功能，便于通用 UI 的集成与使用。

**章节来源**
- [dev\instructions\maafw-guide\3.3-ProjectInterfaceV2协议.md:1-1036](file://dev/instructions/maafw-guide/3.3-ProjectInterfaceV2协议.md#L1-L1036)

### 构建指南
提供了完整的本地开发与在线开发环境搭建指导，包括依赖安装、CMake 预设配置、构建安装等步骤。

**章节来源**
- [dev\instructions\maafw-guide\4.1-构建指南.md:1-74](file://dev/instructions/maafw-guide/4.1-构建指南.md#L1-L74)

### 标准化接口设计
定义了 MaaFramework 绑定的标准设计原则，包括对象化封装、异步任务处理、回调解析等关键设计要点。

**章节来源**
- [dev\instructions\maafw-guide\4.2-标准化接口设计.md:1-60](file://dev/instructions/maafw-guide/4.2-标准化接口设计.md#L1-L60)

### 问题反馈流程
建立了完善的问题反馈流程，包括日志收集、配置提供、崩溃处理、识别问题诊断等关键环节，帮助开发者快速定位和解决问题。

**章节来源**
- [dev\instructions\maafw-guide\5.1-问题反馈.md:1-150](file://dev/instructions/maafw-guide/5.1-问题反馈.md#L1-L150)
...
DH[DebugHandler<br/>调试协议处理器 V1]
end
subgraph "服务层"
DSV2[DebugServiceV2<br/>调试服务 V2]
DS[DebugService<br/>调试服务 V1]
...
- [debug_service_v2.go](file://LocalBridge/internal/mfw/debug_service_v2.go#L58-L63)
...
**章节来源**
- [debug_service_v2.go](file://LocalBridge/internal/mfw/debug_service_v2.go#L17-L56)
...
Handler->>Service : CreateSession(resource, controller)
Service->>Adapter : 初始化控制器和资源
...
**章节来源**
- [debug_service_v2.go](file://LocalBridge/internal/mfw/debug_service_v2.go#L58-L186)

### DebugHandlerV2 - 调试协议处理器 V2
DebugHandlerV2 是调试服务 V2 的协议层实现，负责处理 WebSocket 消息和路由分发。

#### 支持的路由
- `/mpe/debug/create_session`: 创建调试会话
...
Route --> Screencap[截图]
CreateSession --> CreateCallback[创建事件回调]
...
**章节来源**
- [handler_v2.go](file://LocalBridge/internal/protocol/debug/handler_v2.go#L16-L491)
...
**章节来源**
- [debug_service_v2.go](file://LocalBridge/internal/mfw/debug_service_v2.go#L38-L143)
...
- [debug_service_v2.go](file://LocalBridge/internal/mfw/debug_service_v2.go#L77-L111)

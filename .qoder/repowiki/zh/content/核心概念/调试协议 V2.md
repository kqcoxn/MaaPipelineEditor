...
## 更新摘要
**变更内容**
- 新增会话管理端点：create_session、destroy_session、list_sessions、get_session
- 新增调试控制端点：start、run、stop
- 新增数据查询端点：get_node_data、screencap
- 增强前端动态资源路径管理功能
- 扩展事件系统支持更多事件类型
- 支持多资源路径加载和Agent连接
...
**更新** 本次更新反映了协议层的重大扩展，包括新增的会话管理端点、调试控制端点、数据查询端点等，以及与前端DebugPanel.tsx的动态资源路径管理功能的配合。
...
**更新** 本次重大扩展进一步增强了调试协议的功能完整性，新增的会话管理、调试控制、数据查询端点以及动态资源路径管理功能，使得调试系统更加完善和实用，为开发者提供了更加强大和灵活的调试工具。
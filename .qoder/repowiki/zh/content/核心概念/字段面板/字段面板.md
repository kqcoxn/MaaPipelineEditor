...
## 更新摘要
**已做更改**  
- 新增了内嵌模式（inline mode）的详细说明，包括其工作原理和使用场景
- 增加了内嵌面板缩放比例的配置说明
- 更新了字段面板的架构概述，以反映可拖拽模式、固定模式和内嵌模式三种模式
- 更新了核心组件分析，包括对 `InlineFieldPanel` 组件的分析
- 更新了依赖分析，增加了新的依赖关系

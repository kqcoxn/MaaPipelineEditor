...
## 更新摘要
**变更内容**
- startDebug函数新增skipEntryNodeCheck选项，支持跳过入口节点检查
- 自动保存功能改进，新增saveFilesBeforeDebug配置项，支持调试前自动保存所有文件
- 单节点调试支持，包括测试模式状态管理、测试结果分析和智能结果解释功能
...
- **新增**：调试设置区域，包含 saveFilesBeforeDebug 配置开关

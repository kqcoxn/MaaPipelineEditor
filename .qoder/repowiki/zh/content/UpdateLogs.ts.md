...
## 更新摘要
**变更内容**
- 更新了版本历史记录，添加了版本1.3.1的新功能"拖拽连接到空白处时，可唤醒新增节点面板（默认开启，可在设置面板关闭）"
- 新增了连接空白处功能的技术实现分析
- 更新了版本历史表格以反映最新的功能增强
...
- [updateLogs.ts:1-679](file://src/data/updateLogs.ts#L1-L679)
...
**更新** 最新版本（1.3.1）的更新记录体现了系统在功能增强方面的重大突破：

| 版本号 | 发布日期 | 类型 | 主要特性 |
|--------|----------|------|----------|
| 1.3.1 | 2026-3 | feature | **自定义排序功能同步影响字段面板与节点渲染，字段顺序对应一致**<br/>**拖拽连接到空白处时，可唤醒新增节点面板（默认开启，可在设置面板关闭）** |
...
**章节来源**
- [updateLogs.ts:49-679](file://src/data/updateLogs.ts#L49-L679)

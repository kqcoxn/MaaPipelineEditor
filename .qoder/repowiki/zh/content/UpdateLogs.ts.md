...
## 更新摘要
**变更内容**
- 更新了版本历史记录，新增1.4.0版本的Anchor节点高亮索引与快捷跳转功能说明
- 修正版本1.3.1的发布日期为'2026-3-25'
...
- [updateLogs.ts:1-696](file://src/data/updateLogs.ts#L1-L696)
...
**更新** 最新版本（1.4.0）的更新记录体现了系统在功能增强方面的重大突破，包含以下重要特性：

| 版本号 | 发布日期 | 类型 | 主要特性 |
|--------|----------|------|----------|
| 1.4.0 | 2026-3 | major | **🌟 Anchor 节点支持高亮索引与可跨文件快捷跳转**<br/>**🥂 右键节点面板可粘贴复制项，直接生成在指针位置**<br/>**优化节点字段智能填充效果**<br/>**优化 OCR 加载失败时的提示**<br/>**优化节点添加面板排序，精简左侧节点列表** |
...
**章节来源**
- [updateLogs.ts:49-696](file://src/data/updateLogs.ts#L49-L696)
...
**更新** 最新版本（1.4.0）特别体现了系统在功能增强方面的重大突破。通过引入Anchor节点高亮索引与可跨文件快捷跳转功能，用户现在可以直观地看到哪些节点引用了特定的Anchor，并通过右键菜单快速跳转到目标节点，支持跨文件跳转，大大提升了复杂工作流中的导航效率。同时，右键节点面板新增的粘贴功能允许用户直接在指针位置粘贴复制的节点，无需额外操作，进一步提升了工作效率。

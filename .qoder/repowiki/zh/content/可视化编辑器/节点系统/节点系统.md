...
- [src/features/debug/hooks/useDebugModalController.ts](file://src/features/debug/hooks/useDebugModalController.ts)
...
NODECMENU["NodeContextMenu.tsx<br/>菜单渲染/交互"]
end
subgraph "状态与服务"
...
DEBUGMEM["debugModalMemoryStore.ts<br/>调试模态记忆"]
DEBUGSESS["debugSessionStore.ts<br/>调试会话状态"]
END
subgraph "样式"
...
- [src/components/flow/nodes/nodeContextMenu.tsx:1-698](file://src/components/flow/nodes/nodeContextMenu.tsx#L1-L698)
- [src/components/flow/nodes/components/NodeContextMenu.tsx:1-259](file://src/components/flow/nodes/components/NodeContextMenu.tsx#L1-L259)
- [src/stores/flow/index.ts](file://src/stores/flow/index.ts)
- [src/services/server.ts](file://src/services/server.ts)
- [src/services/crossFileService.ts](file://src/services/crossFileService.ts)
- [src/stores/debugModalMemoryStore.ts:1-251](file://src/stores/debugModalMemoryStore.ts#L1-L251)
- [src/stores/debugSessionStore.ts:1-273](file://src/stores/debugSessionStore.ts#L1-L273)
- [src/styles/flow/nodes.module.less](file://src/styles/flow/nodes.module.less)
...
- [src/components/flow/nodes/nodeContextMenu.tsx:467-698](file://src/components/flow/nodes/nodeContextMenu.tsx#L467-L698)
...
MENU["上下文菜单层<br/>nodeContextMenu.tsx + NodeContextMenu.tsx"]
STORE["状态层<br/>stores/flow/index.ts"]
SERVICE["服务层<br/>server.ts / crossFileService.ts"]
DEBUGMEM["调试模态记忆<br/>debugModalMemoryStore.ts"]
DEBUGSESS["调试会话状态<br/>debugSessionStore.ts"]
...
CMENU --> DEBUGMEM["stores/debugModalMemoryStore.ts"]
CMENU --> DEBUGSESS["stores/debugSessionStore.ts"]
...
**更新** 节点上下文菜单经过简化，移除了自动关闭调试模态的功能，使交互更加可控和可预测。用户现在可以更好地掌控调试流程的状态，避免意外的模态框关闭。

...
graph TB
subgraph "前端"
FCS["文件配置面板<br/>FileConfigSection.tsx"]
...
**图表来源**
- [FileConfigSection.tsx:10-72](file://src/components/panels/config/FileConfigSection.tsx#L10-L72)
- [LocalFileListPanel.tsx:20-165](file://src/components/panels/main/LocalFileListPanel.tsx#L20-L165)
- [fileStore.ts:329-800](file://src/stores/fileStore.ts#L329-L800)
...
## 核心组件
- 文件配置面板：提供“节点前缀”和“文件路径”的配置入口，支持实时校验与提示。
...
```mermaid
graph LR
FCS["FileConfigSection.tsx"] --> FS["fileStore.ts"]

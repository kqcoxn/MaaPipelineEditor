...
- [FieldPanel.module.less:1-207](file://src/styles/panels/FieldPanel.module.less#L1-L207)
...
- **标签页容器**：`.ant-tabs-tabpane` 设置了 `overflow-y: auto` 和 `overflow-x: hidden`，确保内容垂直滚动时不会出现水平滚动条
...
- [FieldPanel.module.less:32-35](file://src/styles/panels/FieldPanel.module.less#L32-L35)
...
- **标签页容器**：`.ant-tabs-tabpane` 设置了 `overflow-y: auto` 和 `overflow-x: hidden`

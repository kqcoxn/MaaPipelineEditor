...
- [src/stores/debugModalMemoryStore.ts:1-308](file://src/stores/debugModalMemoryStore.ts#L1-L308)
...
- 模态记忆存储：持久化调试面板与运行模式偏好，支持过滤、排序、详情模式等
...
图表来源
- [src/stores/debugModalMemoryStore.ts:185-241](file://src/stores/debugModalMemoryStore.ts#L185-L241)
...
- 调试模态偏好：
  - 面板切换、运行模式、自动AI摘要、自动关闭/打开、过滤器与排序、详情模式

...
## 结论
通过本快速开始指南，您可以在 30 分钟内完成 MPE 的安装与首个 Pipeline 工作流的创建。**重要变更**：Extremer 本地一体包服务暂时下线，推荐使用 Web + LocalBridge 模式获得完整的本地能力。建议新手优先尝试在线使用，熟悉基本操作后再根据需要启用 LocalBridge 服务。遇到问题时，可参考本指南的故障排除章节或查阅文档站。

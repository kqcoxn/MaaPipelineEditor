...
## 更新摘要
**所做更改**
- 更新了项目架构描述，反映 Extremer 项目的完全移除
- 修改了 CI/CD 流水线配置相关的内容，删除了与 Extremer 相关的构建流程
- 更新了构建脚本和部署流程的说明
- 修正了项目历史和发展路线图中的相关信息
...
**重要更新**：Extremer 项目已完全移除，当前版本专注于在线编辑器和本地服务的组合使用模式。
...
- 前端更新检查：直接调用 GitHub Releases API，解析最新版本、发布说明、发布时间与平台匹配的下载链接。
...
## 依赖分析
- Extremer 依赖 Wails v2 作为应用框架，使用 go-version 进行版本比较。
...
**重要更新**：随着 Extremer 项目的移除，项目现在更加专注于在线编辑器和本地服务的组合使用模式，提供了更简洁的部署和使用方式。

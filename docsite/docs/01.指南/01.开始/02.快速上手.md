...
::: warning 暂时下线
Extremer 本地一体包暂时停止提供下载，正在重构中。如需本地能力，请使用上述的 LocalBridge 模式，功能完全等价。
:::

如果您希望获得更便捷的本地化体验，可以下载 MaaPipelineExtremer (MPE) 一体集成包。集成包整合了 Editor 前端与 LocalBridge 本地服务，无需额外配置即可直接使用，部署方式可参考 [本地一体包](/guide/extremer/deploy) 章节。

::: tip
对于各个使用方案的区别，您可以参考 [产品矩阵](/guide/start/product-matrix) 章节。
:::

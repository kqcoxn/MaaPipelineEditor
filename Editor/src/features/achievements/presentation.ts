...
export const achievementConnections: [string, string][] = [
  ["canvas_first_node", "canvas_first_edge"],
  ["canvas_first_node", "node_created"],
  ["canvas_first_node", "canvas_first_paste"],
  ["canvas_first_edge", "canvas_edges_50"],
  ["canvas_first_edge", "debug_first_run"],
  ["debug_first_run", "debug_run"],
  ["node_created", "explore_group_master"],
  ["canvas_first_paste", "explore_night_owl"],
];

export const categoryIntroductions: Record<AchievementCategory, string> = {
  canvas: "从一个节点，到一张有条理的流程图。",
  debug: "让想法跑起来，让每一次尝试留下足迹。",
  explore: "常用功能之外，还有一些小惊喜。",
};

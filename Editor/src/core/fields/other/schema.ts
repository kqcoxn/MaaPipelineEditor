  ...
  focus: {
    ...
    params: [
      ...
      ...["Starting", "Succeeded", "Failed"].map((phase) => ({
        key: `Node.PipelineNode.${phase}`,
        type: FieldTypeEnum.Any,
        default: "",
        desc: "流水线节点通知。支持字符串或对象 {content?, display?, trace?}。启用遥测的客户端默认上传 Failed，其余阶段默认不上传；trace 可覆盖该默认值。",
      ...
      })),
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "识别开始时触发。可用占位符: task_id, reco_id, name, anchor。值可以是字符串（等价于 display: log）或对象 {content?: string, display?: string|string[], trace?: boolean}。",
      ...
      },
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "识别成功时触发。可用占位符: task_id, reco_id, name, anchor。值可以是字符串或对象 {content?, display?, trace?}。",
        displayName: "Reco.OK",
      },
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "识别失败时触发。可用占位符: task_id, reco_id, name, anchor。值可以是字符串或对象 {content?, display?, trace?}。",
      ...
      // 动作相关消息
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "动作开始时触发。可用占位符: task_id, action_id, name。值可以是字符串或对象 {content?, display?, trace?}。",
      ...
      },
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "动作成功时触发。可用占位符: task_id, action_id, name。值可以是字符串或对象 {content?, display?, trace?}。",
      ...
      },
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "动作失败时触发。可用占位符: task_id, action_id, name。值可以是字符串或对象 {content?, display?, trace?}。",
      ...
      // WaitFreezes 相关消息
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "wait_freezes 开始时触发。可用占位符: task_id, wf_id, name, phase, roi, param。phase 值为: pre/post/repeat/context。值可以是字符串或对象 {content?, display?, trace?}。",
      ...
      },
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "wait_freezes 成功时触发。额外占位符: reco_ids, elapsed。值可以是字符串或对象 {content?, display?, trace?}。",
      ...
      },
      {
        ...
        type: FieldTypeEnum.Any,
        default: "",
        desc: "wait_freezes 失败时触发（如超时）。额外占位符: reco_ids, elapsed。值可以是字符串或对象 {content?, display?, trace?}。",
